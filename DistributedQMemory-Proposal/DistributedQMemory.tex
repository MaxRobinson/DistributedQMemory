...
To add to these works of research I propose a parallelized and distributed version a the Q-learning algorithm using a traditional Q-Value memory database, referred to from here on in as the Q-memory\cite{watkins}.
